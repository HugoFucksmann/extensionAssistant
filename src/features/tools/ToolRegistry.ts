...
import { getFileContents } from './implementations/filesystem/getFileContents';
import { writeToFile } from './implementations/filesystem/writeToFile';
import { listFiles } from './implementations/filesystem/listFiles';

// Importar herramientas de editor
import { getActiveEditorContent } from './implementations/editor/getActiveEditorContent';
import { applyTextEdit } from './implementations/editor/applyTextEdit';

// Importar herramientas de proyecto
import { searchWorkspace } from './implementations/project/searchWorkspace';
import { getProjectInfo } from './implementations/project/getProjectInfo';

// Importar herramienta de respuesta
import { respond } from './implementations/core/respond';

// Importar EventEmitter3 para el bus de eventos
import EventEmitter from 'eventemitter3';
import { ParameterDefinition, Tool, ToolResult } from './types';
...
export class ToolRegistry {
  ...
  private validateToolParameters(tool: Tool, params: any): void {
    ...
    const requiredParams = Object.entries<ParameterDefinition>(tool.schema.parameters)
